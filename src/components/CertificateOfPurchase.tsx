...
const CertificateOfPurchase = () => {
  return (
    <div className="max-w-lg mx-auto p-6 border border-gray-300 rounded-lg shadow-lg">
      ...
      <h1 className="text-2xl font-bold text-left my-4">
      ...
      <ul className="text-lg mb-4 text-left">
      ...
      <p className="text-lg my-4 text-left">Please accept our highest regards.</p>
      <div className="text-right mt-8">
        <span className="text-3xl font-bold italic">Spiltm</span>
      </div>
    </div>
  );
};
